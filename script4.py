...
def do_goat(inname, outname):
    ...
    def diff_pitch(freqa, freqb):
        r = (2)**(1./12.)
        return not freqa/r<freqb<freqa*r
    ...
    for most_freq in pitch_values:
        ...
        if diff_pitch(most_freq, last_freq):
            if last_freq!=-1:
                ...
                if last_freq==0:
                    ...
                    #last_freq*=2
                    goat_note = get_goat(find_pitch(last_freq)-72)[:nsamps*num_samps]
